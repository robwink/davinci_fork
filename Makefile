...
ACLOCAL = ${SHELL} /d/mingw_msys/davinci/config/missing --run aclocal-1.9
AUTOCONF = ${SHELL} /d/mingw_msys/davinci/config/missing --run autoconf
AUTOMAKE = ${SHELL} /d/mingw_msys/davinci/config/missing --run automake-1.9
AUTOHEADER = ${SHELL} /d/mingw_msys/davinci/config/missing --run autoheader
...
OBJEXT = o
PATH_SEPARATOR = :
AMTAR = ${SHELL} /d/mingw_msys/davinci/config/missing --run tar
AR = ar
AS = @AS@
AWK = gawk
CC = gcc
...
LN_S = ln -s
MAINT = #
MY_SUBDIRS =  iomedley modules libltdl modules/thm
OBJDUMP = @OBJDUMP@
PACKAGE = davinci
RANLIB = ranlib
RC = @RC@
...
am__include = include
am__quote = 
install_sh = /d/mingw_msys/davinci/config/install-sh
...
SUBDIRS =  iomedley modules libltdl modules/thm libltdl
...
LINK = $(LIBTOOL) --mode=link $(CCLD) $(AM_CFLAGS) $(CFLAGS) \
	$(AM_LDFLAGS) $(LDFLAGS) -o $@
CFLAGS = -g -O2  -I$(top_srcdir)/iomedley -I${top_srcdir}/libltdl
...
.PHONY: $(RECURSIVE_TARGETS) GTAGS all all-am check check-am clean \
	...
	clean-noinstLIBRARIES clean-recursive dist dist-all dist-gzip \

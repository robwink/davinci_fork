...
Var* rotation(Var* obj, float angle, float ign)
{
	...
	switch (V_FORMAT(obj)) {
	case BYTE: ign_resized.b   = ign; break;
	case SHORT: ign_resized.s  = ign; break;
	case INT: ign_resized.i    = ign; break;
	case FLOAT: ign_resized.f  = ign; break;
	case DOUBLE: ign_resized.d = ign; break;
	default: break;
	}

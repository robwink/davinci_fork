...
g++ -m$ARCH -fPIC -shared -Wl,-soname,isis3.dvio -Wl,-rpath=$ISIS3DIR/3rdParty/lib -o isis3.dvio iomod_isis3.o  -L$ISIS3DIR/lib -L$ISIS3DIR/3rdParty/lib -lisis3 -lkdu_a63R -lgsl -lgeos_c -lqwt -lxerces-c -lprotobuf
if [ $? != 0 ]; then
    echo Link failed.
    exit 1
fi

...
#define MSB8(s)         (swp(((cptr)(s))[0], ((cptr)(s))[7]), \
                         ...
                         swp(((cptr)(s))[3], ((cptr)(s))[4]))

#define MSB4(s)         (swp(((cptr)(s))[0], ((cptr)(s))[3]), \
                         swp(((cptr)(s))[1], ((cptr)(s))[2]))

#define MSB2(s)         (swp(((cptr)(s))[0], ((cptr)(s))[1]))
...
static char * grab_keyval(char *line, char *key, char *val,
    ...
    if (c->n_df_syms) {
      ...
      for (i = 0 ; i < c->n_df_syms ; i++) {
        ...
        switch(d->type) {
          case T_STRING:
            {
              int *len = (int *)(data+(d->loc+hdr_size));
              char *str = (char *)(len+1);

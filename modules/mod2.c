...
static dvModuleFuncDesc exported_list[] = {{"foo", (void*)foo}, {"bar", (void*)bar}};

static dvDepAttr dependencies[] = {{"mod1", NULL}};

static dvModuleInitStuff is = {exported_list, 2, dependencies, 1};

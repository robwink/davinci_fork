...
int gui_isErrorDialog(const char* name)
{
...
Widget gui_initErrorDialog(const char* dvName, WidgetClass class, Widget parent, Var* dvResources,
                           void** instanceData, Narray* publicResources)
{
	Widget dialog;
...
#if DEBUG
	fprintf(stderr,
	        "DEBUG: gui_initErrorDialog(dvName = \"%s\", class = %ld, "

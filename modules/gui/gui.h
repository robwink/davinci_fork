...
typedef Var* (*_get_resource_func)(const Widget, const String, const String);
typedef XtArgVal (*_set_resource_func)(const Widget, const String, const String, const Var*, FreeStackList);
...
XtArgVal gui_setEnum(const Widget, const String, const String, const Var*, FreeStackList);
Var* gui_getWidget(const Widget, const String, const String);
XtArgVal gui_setWidget(const Widget, const String, const String, const Var*, FreeStackList);
Var* gui_getBoolean(const Widget, const String, const String);
XtArgVal gui_setBoolean(const Widget, const String, const String, const Var*, FreeStackList);
Var* gui_getBool(const Widget, const String, const String);
XtArgVal gui_setBool(const Widget, const String, const String, const Var*, FreeStackList);
Var* gui_getByte(const Widget, const String, const String);
XtArgVal gui_setByte(const Widget, const String, const String, const Var*, FreeStackList);
Var* gui_getShort(const Widget, const String, const String);
XtArgVal gui_setShort(const Widget, const String, const String, const Var*, FreeStackList);
Var* gui_getFloat(const Widget, const String, const String);
XtArgVal gui_setFloat(const Widget, const String, const String, const Var*, FreeStackList);
Var* gui_getDouble(const Widget, const String, const String);
XtArgVal gui_setDouble(const Widget, const String, const String, const Var*, FreeStackList);
Var* gui_getInt(const Widget, const String, const String);
XtArgVal gui_setInt(const Widget, const String, const String, const Var*, FreeStackList);
Var* gui_getCardinal(const Widget, const String, const String);
XtArgVal gui_setCardinal(const Widget, const String, const String, const Var*, FreeStackList);
Var* gui_getDimension(const Widget, const String, const String);
XtArgVal gui_setDimension(const Widget, const String, const String, const Var*, FreeStackList);
Var* gui_getString(const Widget, const String, const String);
XtArgVal gui_setString(const Widget, const String, const String, const Var*, FreeStackList);
Var* gui_getXmString(const Widget, const String, const String);
XtArgVal gui_setXmString(const Widget, const String, const String, const Var*, FreeStackList);
...
XtArgVal gui_setXmStringTable(const Widget, const String, const String, const Var*, FreeStackList);
XtArgVal gui_setXmStringTableFromStrings(const Widget, const String, const String,
                                         const char** values, int n_vals, FreeStackList);
Var* gui_getTextPosition(const Widget, const String, const String);
XtArgVal gui_setTextPosition(const Widget, const String, const String, const Var*, FreeStackList);
XtArgVal gui_setListItems(const Widget, const String, const String, const Var*, FreeStackList);
XtArgVal gui_setReadOnly(const Widget, const String, const String, const Var*, FreeStackList);

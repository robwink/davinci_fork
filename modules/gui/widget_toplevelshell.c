...
int gui_isTopLevelShell(const char* name)
{
...
Widget gui_initTopLevelShell(const char* dvName, WidgetClass class, Widget parent, Var* dvResources,
                             void** instanceData, Narray* publicResources, Widget* outerWidget)
{
...
#if DEBUG
	fprintf(stderr,
	        "DEBUG: gui_initTopLevelShell(dvName = \"%s\", class = %ld, "
	...
	topShell = XtCreatePopupShell(dvName, topLevelShellWidgetClass, parent, xtArgs, xtArgCount);
...
Narray* gui_getTopLevelShellPublicResources()
{

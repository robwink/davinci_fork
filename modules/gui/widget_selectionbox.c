...
int gui_isSelectionBox(const char* name)
{
...
Narray* gui_getSelectionBoxPublicResources()
{
...
void gui_setSelectionBoxPseudoResources(Widget widget, Var* dvStruct, Narray* publicResources)
{
...
#if DEBUG
	fprintf(stderr,
	        "DEBUG: gui_setSelectionBoxPseudoResources(widget = %ld, "

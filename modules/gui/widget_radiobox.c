...
static CallbackEntry radioBoxCallbacks[] = {{"entry", XmNentryCallback, gui_defaultCallback},
...
int gui_isRadioBox(const char* name)
{
...
Widget gui_initRadioBox(const char* dvName, WidgetClass class, Widget parent, Var* dvResources,
...
#if DEBUG
	fprintf(stderr,
	        "DEBUG: gui_initRadioBox(dvName = \"%s\", class = %ld, "
...
#if DEBUG
	fprintf(stderr,
	        "DEBUG: calling XmCreateRadioBox(parent = %ld, "
...
Narray* gui_getRadioBoxPublicResources()
{

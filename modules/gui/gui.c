...
#endif
Widget gui_initDefault(const char*, WidgetClass, Widget, Var*, void**, Narray*, Widget*);
...
static void gui_getResourceValues(Widget, Var*, Narray*, int, XtResourceList*, Cardinal);
static int gui_doSetResourceValues(Widget, char*, Var*, Arg*, Cardinal*, FreeStackList,
...
static const char* ignoreTypes[] = {"AcceleratorTable",   /* XmTextField */
...
static const char* dimensionTypes[] = {"HorizontalDimension", "VerticalDimension",
                                       "BooleanDimension", "Dimension", NULL};
...
static const char* intTypes[] = {"Int", "TopItemPosition", "VerticalInt", "HorizontalInt", NULL};
static const char* shortTypes[] = {"Short", "Position", "HorizontalPosition", "VerticalPosition", NULL};
...
static const char* enumTypes[] = {"UnitType",
                                  "VerticalAlignment",
                                  "RowColumnType",
                                  "Alignment",
                                  "Orientation",
...
static EnumNameEntry alignmentEnums[] = {{"ALIGNMENT_BEGINNING", XmALIGNMENT_BEGINNING},
                                         {"ALIGNMENT_CENTER", XmALIGNMENT_CENTER},
                                         {"ALIGNMENT_END", XmALIGNMENT_END},
                                         {NULL, 0}};

static EnumNameEntry arrowDirectionEnums[] = {{"ARROW_UP", XmARROW_UP},
                                              {"ARROW_DOWN", XmARROW_DOWN},
                                              {"ARROW_LEFT", XmARROW_LEFT},
                                              {"ARROW_RIGHT", XmARROW_RIGHT},
                                              {NULL, 0}};

static EnumNameEntry fileTypeMaskEnums[] = {{"DIRECTORY", XmFILE_DIRECTORY},
                                            {"REGULAR", XmFILE_REGULAR},
                                            {"ANY_TYPE", XmFILE_ANY_TYPE},
                                            {NULL, 0}};

static EnumNameEntry multiClickEnums[] = {{"MULTICLICK_DISCARD", XmMULTICLICK_DISCARD},
                                          {"MULTICLICK_KEEP", XmMULTICLICK_KEEP},
                                          {NULL, 0}};

static EnumNameEntry orientationEnums[] = {{"VERTICAL", XmVERTICAL}, {"HORIZONTAL", XmHORIZONTAL}, {NULL, 0}};

static EnumNameEntry resizePolicyEnums[] = {{"RESIZE_NONE", XmRESIZE_NONE},
                                            {"RESIZE_GROW", XmRESIZE_GROW},
                                            {"RESIZE_ANY", XmRESIZE_ANY},
                                            {NULL, 0}};

static EnumNameEntry shadowTypeEnums[] = {{"SHADOW_IN", XmSHADOW_IN},
                                          {"SHADOW_OUT", XmSHADOW_OUT},
                                          {"SHADOW_ETCHED_IN", XmSHADOW_ETCHED_IN},
                                          {"SHADOW_ETCHED_OUT", XmSHADOW_ETCHED_OUT},
                                          {NULL, 0}};

static EnumNameEntry unitTypeEnums[] = {{"PIXELS", XmPIXELS},
...
static EnumNameEntry listSizePolicyEnums[] = {{"VARIABLE", XmVARIABLE},
                                              {"CONSTANT", XmCONSTANT},
                                              {"RESIZE_IF_POSSIBLE", XmRESIZE_IF_POSSIBLE},
                                              {NULL, 0}};

static EnumNameEntry scrollBarDisplayPolicyEnums[] = {{"STATIC", XmSTATIC},
                                                      {"AS_NEEDED", XmAS_NEEDED},
                                                      {NULL, 0}};

static EnumNameEntry scrollBarPlacementEnums[] = {{"TOP_LEFT", XmTOP_LEFT},
                                                  {"BOTTOM_LEFT", XmBOTTOM_LEFT},
                                                  {"TOP_RIGHT", XmTOP_RIGHT},
                                                  {"BOTTOM_RIGHT", XmBOTTOM_RIGHT},
                                                  {NULL, 0}};

static EnumNameEntry scrollingPolicyEnums[] = {{"AUTOMATIC", XmAUTOMATIC},
                                               {"APPLICATION_DEFINED", XmAPPLICATION_DEFINED},
                                               {NULL, 0}};

static EnumNameEntry selectionPolicyEnums[] = {{"SINGLE_SELECT", XmSINGLE_SELECT},
                                               {"MULTIPLE_SELECT", XmMULTIPLE_SELECT},
                                               {"BROWSE_SELECT", XmBROWSE_SELECT},
                                               {"EXTENDED_SELECT", XmEXTENDED_SELECT},
                                               {NULL, 0}};

static EnumNameEntry packingEnums[] = {{"PACK_TIGHT", XmPACK_TIGHT},
...
static EnumNameEntry rowColumnTypeEnums[] = {
    ...
    {"MENU_POPUP", XmMENU_POPUP},   {"MENU_PULLDOWN", XmMENU_PULLDOWN},
    {"MENU_OPTION", XmMENU_OPTION}, {NULL, 0}};

static EnumNameEntry tearOffModelEnums[] = {{"TEAR_OFF_DISABLED", XmTEAR_OFF_DISABLED},
                                            {"TEAR_OFF_ENABLED", XmTEAR_OFF_ENABLED},
                                            {NULL, 0}};

static EnumNameEntry stringDirectionEnums[] = {{"STRING_DIRECTION_L_TO_R", XmSTRING_DIRECTION_L_TO_R},
                                               {"STRING_DIRECTION_R_TO_L", XmSTRING_DIRECTION_R_TO_L},
                                               {"STRING_DIRECTION_DEFAULT", XmSTRING_DIRECTION_DEFAULT},
                                               {NULL, 0}};

static EnumNameEntry processingDirectionEnums[] = {{"MAX_ON_TOP", XmMAX_ON_TOP},
                                                   {"MAX_ON_BOTTOM", XmMAX_ON_BOTTOM},
                                                   {"MAX_ON_LEFT", XmMAX_ON_LEFT},
                                                   {"MAX_ON_RIGHT", XmMAX_ON_RIGHT},
                                                   {NULL, 0}};

static EnumNameEntry separatorTypeEnums[] = {{"NO_LINE", XmNO_LINE},
...
static EnumNameEntry indicatorTypeEnums[] = {{"N_OF_MANY", XmN_OF_MANY},
                                             {"ONE_OF_MANY", XmONE_OF_MANY},
                                             {NULL, 0}};

static EnumNameEntry attachmentEnums[] = {{"ATTACH_NONE", XmATTACH_NONE},
...
static EnumNameEntry toggleEnums[] = {{"TOGGLE_SET", XmSET},
                                      {"TOGGLE_UNSET", XmUNSET},
                                      {"TOGGLE_INDETERMINATE", XmINDETERMINATE},
                                      {NULL, 0}};

static EnumNameEntry editModeEnums[] = {{"EDIT_SINGLE", XmSINGLE_LINE_EDIT},
                                        {"EDIT_MULTI", XmMULTI_LINE_EDIT},
                                        {NULL, 0}};

static EnumNameEntry comboBoxTypeEnums[] = {{"COMBO_LIST", XmCOMBO_BOX},
...
static EnumNameEntry vicarDataSavePolicyEnums[] = {{"NONE", XvicNONE},
                                                   {"RAW", XvicRAW},
                                                   {"XIMAGE", XvicXIMAGE},
                                                   {"PIXMAP", XvicPIXMAP},
                                                   {NULL, 0}};
...
static EnumNameEntry vicarDataTypeEnums[] = {
    {"DV_UINT8", XvicBYTE}, {"HALF", XvicHALF}, {"UHALF", XvicUHALF},      {"FULL", XvicFULL},
    {"UFULL", XvicUFULL},   {"REAL", XvicREAL}, {"DV_DOUBLE", XvicDOUBLE}, {NULL, 0}};

static EnumNameEntry vicarDitherModeEnums[] = {{"NONE", XvicNONE},
                                               {"ORDERED", XvicORDERED},
                                               {"KAGELS", XvicKAGELS},
                                               {NULL, 0}};

static EnumNameEntry vicarImageModeEnums[] = {{"COLOR", XvicCOLOR}, {"BW", XvicBW}, {NULL, 0}};

static EnumNameEntry vicarLutTypeEnums[] = {{"STRETCH", XvicSTRETCH},
                                            {"RAW", XvicRAW},
                                            {"PSEUDO", XvicPSEUDO},
                                            {"PSEUDO_ONLY", XvicPSEUDO_ONLY},
                                            {NULL, 0}};

static EnumNameEntry vicarLut16TypeEnums[] = {{"STRETCH", XvicSTRETCH},
                                              {"RAW", XvicRAW},
                                              {"PSEUDO", XvicPSEUDO},
                                              {"PSEUDO_ONLY", XvicPSEUDO_ONLY},
                                              {NULL, 0}};

static EnumNameEntry vicarStretchPolicyEnums[] = {{"USE_HW", XvicUSE_HW}, {"USE_SW", XvicUSE_SW}, {NULL, 0}};

static EnumNameEntry vicarColormapPolicyEnums[] = {{"FULL", XvicFULL},
                                                   {"HALF", XvicHALF},
                                                   {"DITHER", XvicDITHER},
                                                   {"ALLOC", XvicALLOC},
...
static EnumNameEntry vicarVisualTypeEnums[] = {{"USE_DEFAULT", XvicUSE_DEFAULT},
                                               {"USE_8BIT", XvicUSE_8BIT},
                                               {"USE_24BIT", XvicUSE_24BIT},
                                               {NULL, 0}};

static EnumNameEntry vicarWorkProcPolicyEnums[] = {{"NONE", XvicNONE},
                                                   {"READ", XvicREAD},
                                                   {"ALL", XvicALL},
                                                   {NULL, 0}};
...
static EnumTypeNameMapEntry EnumTypeNameMap[] = {{XmRUnitType, unitTypeEnums},
...
typedef Widget (*_init_func)(const char*, WidgetClass, Widget, Var*, void**, Narray*, Widget*);
...
static WidgetMapEntry WidgetMap[] = {
     ...
     */
    {gui_isTop, NULL, NULL, NULL, NULL, NULL, NULL, NULL},
    /* xmArrowButtonWidgetClass */
    {gui_isArrowButton, gui_initDefault, gui_destroyDefault, gui_getArrowButtonClass,
     gui_getArrowButtonCallbacks, NULL, NULL, gui_getArrowButtonPublicResources},
    /* xmFrameWidgetClass */
    {gui_isFrame, gui_initDefault, gui_destroyDefault, gui_getFrameClass, NULL, NULL, NULL,
     gui_getFramePublicResources},
    /* xmLabelWidgetClass */
    {gui_isLabel, gui_initDefault, gui_destroyDefault, gui_getLabelClass, NULL, NULL, NULL,
     gui_getLabelPublicResources},
    /* xmListWidgetClass */
    {gui_isList, gui_initDefault, gui_destroyDefault, gui_getListClass, gui_getListCallbacks,
     gui_getListPseudoResources, gui_setListPseudoResources, gui_getListPublicResources},
    /* xmScrollBarWidgetClass */
    {gui_isScrollBar, gui_initDefault, gui_destroyDefault, gui_getScrollBarClass,
     gui_getScrollBarCallbacks, NULL, NULL, NULL},
    /* xmTextWidgetClass */
    {gui_isText, gui_initDefault, gui_destroyDefault, gui_getTextClass, gui_getTextCallbacks, NULL,
     NULL, NULL},
    /* xmTextFieldWidgetClass */
    {gui_isTextField, gui_initDefault, gui_destroyDefault, gui_getTextFieldClass,
     gui_getTextFieldCallbacks, NULL, NULL, gui_getTextFieldPublicResources},
    /* xmCascadeButtonWidgetClass */
    {gui_isCascadeButton, gui_initDefault, gui_destroyDefault, gui_getCascadeButtonClass,
     gui_getCascadeButtonCallbacks, NULL, NULL, gui_getCascadeButtonPublicResources},
    /* xmComboBoxClass */
    {gui_isComboBox, gui_initDefault, gui_destroyDefault, gui_getComboBoxClass,
     gui_getComboBoxCallbacks, NULL, NULL, NULL},
    /* xmCommandWidgetClass */
    {gui_isCommand, gui_initDefault, gui_destroyDefault, gui_getCommandClass, gui_getCommandCallbacks,
     gui_getCommandPseudoResources, gui_setCommandPseudoResources, gui_getCommandPublicResources},
    /* xmDrawnButtonWidgetClass */
    {gui_isDrawnButton, gui_initDefault, gui_destroyDefault, gui_getDrawnButtonClass,
     gui_getDrawnButtonCallbacks, NULL, NULL, NULL},
    /* xmErrorDialogWidgetClass */
    {gui_isErrorDialog, gui_initDefault, gui_destroyDefault, gui_getErrorDialogClass,
     gui_getErrorDialogCallbacks, NULL, NULL, NULL},
    /* xmFileSelectionBoxWidgetClass */
    {gui_isFileSelectionBox, gui_initDefault, gui_destroyDefault, gui_getFileSelectionBoxClass,
     gui_getFileSelectionBoxCallbacks, gui_getFileSelectionBoxPseudoResources,
     gui_setFileSelectionBoxPseudoResources, gui_getFileSelectionBoxPublicResources},
    /* xmFormWidgetClass */
    {gui_isForm, gui_initDefault, gui_destroyDefault, gui_getFormClass, NULL, NULL, NULL, NULL},
    /* xmPanedWindowWidgetClass */
    {gui_isPanedWindow, gui_initDefault, gui_destroyDefault, gui_getPanedWindowClass, NULL, NULL,
     NULL, gui_getPanedWindowPublicResources},
    /* xmPushButtonWidgetClass */
    {gui_isPushButton, gui_initDefault, gui_destroyDefault, gui_getPushButtonClass,
     gui_getPushButtonCallbacks, NULL, NULL, gui_getPushButtonPublicResources},
    /* xmMenuBarWidgetClass */
    {gui_isMenuBar, gui_initMenuBar, gui_destroyDefault, gui_getMenuBarClass, NULL, NULL, NULL, NULL},
    /* RadioBox */
    {gui_isRadioBox, gui_initRadioBox, gui_destroyDefault, gui_getRadioBoxClass,
     gui_getRadioBoxCallbacks, NULL, NULL, gui_getRadioBoxPublicResources},
    /* xmRowColumnWidgetClass */
    {gui_isRowColumn, gui_initDefault, gui_destroyDefault, gui_getRowColumnClass,
     gui_getRowColumnCallbacks, NULL, NULL, gui_getRowColumnPublicResources},
    /* xmScaleWidgetClass */
    {gui_isScale, gui_initDefault, gui_destroyDefault, gui_getScaleClass, gui_getScaleCallbacks,
     NULL, NULL, gui_getScalePublicResources},
    /* ScrolledList */
    {gui_isScrolledList, gui_initScrolledList, gui_destroyDefault, gui_getScrolledListClass,
     gui_getScrolledListCallbacks, gui_getScrolledListPseudoResources,
     gui_setScrolledListPseudoResources, gui_getScrolledListPublicResources},
    /* xmScrolledWindowWidgetClass */
    {gui_isScrolledWindow, gui_initDefault, gui_destroyDefault, gui_getScrolledWindowClass,
     gui_getScrolledWindowCallbacks, NULL, NULL, gui_getScrolledWindowPublicResources},
    /* xmSelectionBoxWidgetClass */
    {gui_isSelectionBox, gui_initDefault, gui_destroyDefault, gui_getSelectionBoxClass,
     gui_getSelectionBoxCallbacks, gui_getSelectionBoxPseudoResources,
     gui_setSelectionBoxPseudoResources, gui_getSelectionBoxPublicResources},
    /* xmSeparatorWidgetClass */
    {gui_isSeparator, gui_initDefault, gui_destroyDefault, gui_getSeparatorClass, NULL, NULL, NULL,
     gui_getSeparatorPublicResources},
    /* xmToggleButtonWidgetClass */
    {gui_isToggleButton, gui_initDefault, gui_destroyDefault, gui_getToggleButtonClass,
     gui_getToggleButtonCallbacks, NULL, NULL, gui_getToggleButtonPublicResources},
    /* topLevelShellWidgetClass */
    {gui_isTopLevelShell, gui_initTopLevelShell, gui_destroyDefault, gui_getTopLevelShellClass,
     NULL, NULL, NULL, gui_getTopLevelShellPublicResources},
    /* transientShellWidgetClass */
    {gui_isTransientShell, gui_initTransientShell, gui_destroyDefault, gui_getTransientShellClass,
     NULL, NULL, NULL, gui_getTransientShellPublicResources},
#ifdef PLOT_WIDGETS
    /* xyWidgetClass */
    {gui_isXYPlot, gui_initDefault, gui_destroyDefault, gui_getXYPlotClass, NULL, NULL,
     gui_setXYPlotPseudoResources, NULL},
#endif
    /* lineBoxWidgetClass */
    {gui_isLineBox, gui_initLineBoxWidget, gui_destroyDefault, gui_getLineBoxClass, gui_getLineBoxCallbacks,
     gui_getLineBoxPseudoResources, gui_setLineBoxPseudoResources, gui_getLineBoxPublicResources},
#if 0
    ...
    {gui_isVicar, gui_initVicar, gui_destroyVicar, gui_getVicarClass, gui_getVicarCallbacks,
     gui_getVicarPseudoResources, gui_setVicarPseudoResources, gui_getVicarPublicResources},
#endif
    {NULL, NULL, NULL, NULL},
};
...
static dvDepAttr deps[] = {{NULL, NULL}};
...
static dvModuleInitStuff dvinit = {export_funcs, DV_MODULE_FUNC_COUNT, deps, 0};
...
int dv_module_init(const char* modname, dvModuleInitStuff* ini)
{
...
void dv_module_fini(const char* modname)
{
...
static int gui_isTop(const char* name)
{
	return 0;
}
...
static EventQueuePtr inspectEvents(EventWatchList eventList)
{
...
static Var* interpretEvent(EventQueuePtr event)
{
...
static void clearEventWatchList(EventWatchList watchList)
{
...
void gui_defaultCallback(Widget widget, XtPointer clientData, XtPointer callData)
{
...
void gui_pseudoCallback(Widget widget, String callbackName)
{
...
void gui_davinciCallback(CallbackMapEntry* callbackMapEntry)
{
...
#else
		parse_buffer(
		    dupString(callbackMapEntry->evalString)); /* FIX: confirm that string is freed */
#endif
	} else {
...
void gui_addEvent(Widget widget, String eventName)
{
...
void gui_defaultDestroyCallback(Widget widget, XtPointer clientData, XtPointer callData)
{
	...
	dbgprintf(
	    "gui_defaultDestroyCallback(widget = %ld, "
...
static Widget getWidgetFromId(int id)
{
...
static int getIdFromWidget(Widget widget)
{
...
static WidgetClass getWidgetClassFromId(int id)
{
...
MyWidgetList gui_getWidgetListEntryFromWidget(Widget widget)
{
...
static int getWidgetClassIdByName(const char* className)
{
...
static Var* dv_AddCallback(vfuncptr f, Var* args)
{
	...
	while (callbackMapEntry != NULL) {
		if (callbackMapEntry->widgetId == widgetId &&
		    !strcasecmp(callbackMapEntry->dvCallbackName, userCallbackName)) {
...
static Var* dv_ListCallbacks(vfuncptr f, Var* args)
{
	Alist alist[2];
	int widgetId;
	Widget widget;
	...
	/* For each callback defined for widgets of this class, get the current eval string (if any) and
	 * add it
	 * to the return struct.  If no eval string has been set for a given callback, return
	 * "<default>".  If a
	 * callback map entry has a null eval string, "<null>" is returned, but that should never
	 * happen.
	 */
	...
	if (WidgetMap[widgetClassId].getCallbacks != NULL) {
		...
		while (callbacks[i].dvCallbackName != NULL) {
			...
			while (callbackMapEntry != NULL) {
				if (callbackMapEntry->widgetId == widgetId &&
					...
					if (callbackMapEntry->evalString != NULL) {
						...
						tmpString = (char*)calloc(
						    len, sizeof(char)); /* Don't free; normally we'd dupString() anyway. */
			...
			if (foundEval == False) {
				add_struct(dvCallbackList, callbacks[i].dvCallbackName,
				           newString(dupString("<default>")));
			}
...
static Var* dv_RemoveCallback(vfuncptr f, Var* args)
{
	...
	if (callbackMapEntry->xtCallbackName != NULL) {
		XtRemoveCallback(widgetListEntry->widget, callbackMapEntry->xtCallbackName,
		                 callbackMapEntry->callbackProc, (XtPointer)callbackMapEntry);
	}
...
static Var* dv_CreateWidget(vfuncptr f, Var* args)
{
	...
	newWidget = (*WidgetMap[widgetClassId].init)(dvName, widgetClass, parentWidget, dvResources,
	                                             &(widgetListEntry->data), widgetListEntry->publicResources,
	...
	if (dvResources != NULL) {
		...
		gui_setResourceValues(newWidget, widgetClass, dvResources, xtArgs, &freeStack,
		...
		if (WidgetMap[widgetClassId].setPseudoResources != NULL) {
			(*WidgetMap[widgetClassId].setPseudoResources)(newWidget, dvResources,
			                                               widgetListEntry->publicResources);
		}
...
Var* dv_DestroyWidget(vfuncptr f, Var* args)
{
...
void gui_destroyWidget(Widget widget)
{
	...
	while (publicResourcesCount) {
		if (Narray_get(publicResources, --publicResourcesCount, &publicResourcesKey,
		               &publicResourcesValue) == 1) {
...
static Var* dv_Realize(vfuncptr f, Var* args)
{
...
static Var* dv_XEventWait(vfuncptr f, Var* args)
{
	XEvent event;
	Var* returnVal;
...
int gui_isDefault(const char** aliases, const char* name)
{
...
Widget gui_initDefault(const char* dvName, WidgetClass widgetClass, Widget parent, Var* dvResources,
                       void** optData, Narray* publicResources, Widget* outerWidget)
{
	Widget newWidget;
	Arg xtArgs[DV_MAX_XT_ARGS];
	Cardinal xtArgCount;
	...
	dbgprintf(
	    "gui_initDefault(dvName = \"%s\", class = %ld, "
...
void gui_destroyDefault(Widget widget, void* instanceData)
{
...
static int compString(const void* a, const void* b)
{
...
Cardinal gui_setResourceValues(Widget widget, WidgetClass widgetClass, Var* usrStruct, Arg* xtArgs,
                               FreeStackList freeStack, Narray* publicResources)
{
	...
	dbgprintf(
	    "gui_setResourceValues(widget = %ld, "
	    "widgetClass = %ld, usrStruct = %ld, xtArgs = %ld, numXtArgs = %ld, "
	    "freeStack = %ld, publicResources = %ld)\n",
	    widget, widgetClass, usrStruct, xtArgs, numXtArgs, freeStack, publicResources);
	...
	for (usrIdx = 0; usrIdx < numUsrResources; usrIdx++) {
		...
		if (widget != NULL) {
			...
			XtGetConstraintResourceList(XtClass(XtParent(currentWidget)), &xtResources, &numXtResources);

			/* try setting the resource */
			setSuccess = gui_doSetResourceValues(currentWidget, usrResourceName, setValue, xtArgs,
			                                     &numXtArgs, freeStack, &xtResources, numXtResources);
...
static int gui_doSetResourceValues(Widget widget, char* usrResourceName, Var* setValue, Arg* xtArgs,
                                   Cardinal* numXtArgs, FreeStackList freeStack,
...
static Var* dv_XGet(vfuncptr f, Var* args)
{
	Alist alist[5];
...
static Var* gui_getResources(int dvWidgetId, Var* dvResourceList, int dvAllResources)
{
	...
	if (XtParent(constraintWidget) != NULL) {
		...
		XtGetConstraintResourceList(XtClass(XtParent(constraintWidget)), &xtResources, &numResources);
		if (xtResources != NULL) {
			gui_getResourceValues(constraintWidget, dvStruct, visibleResources, dvAllResources,
	...
	gui_getResourceValues(widget, dvStruct, visibleResources, dvAllResources, &xtResources, numResources);
	XtFree((char*)xtResources);
...
void gui_getResourceValues(Widget widget, Var* dvStruct, Narray* visibleResources,
                           int dvAllResources, XtResourceList* xtResources, Cardinal numResources)
{
	...
	dbgprintf(
	    "gui_getResourceValues(widget = %ld, dvStruct = %ld, "
...
static Var* dv_XSet(vfuncptr f, Var* args)
{
	Alist alist[3];
	int dvWidgetId;
	Widget widget;
	...
	if (WidgetMap[widgetClassId].setPseudoResources != NULL) {
		(*WidgetMap[widgetClassId].setPseudoResources)(widget, usrStruct, widgetListEntry->publicResources);
	}

	freeStack.head = freeStack.tail = NULL;

	/* this will actually set the values */
	gui_setResourceValues(widget, widgetClass, usrStruct, xtArgs, &freeStack,
	                      widgetListEntry->publicResources);
...
Var* gui_getString(Widget widget, String resourceName, String resourceType)
{
...
XtArgVal gui_setString(const Widget widget, const String resourceName, const String resourceType,
                       const Var* value, FreeStackList freeStack)
{
	...
	dbgprintf(
	    "gui_setString(widget = %ld, resourceName = '%s', "
...
Var* gui_getPrivate(Widget widget)
{
...
void gui_setPrivate(Widget widget, Var* value)
{
...
Var* gui_getXmString(Widget widget, String resourceName, String resourceType)
{
	Var* o;
	XmString cstrValue;
	String strValue;
...
XtArgVal gui_setXmString(const Widget widget, const String resourceName, const String resourceType,
                         const Var* value, FreeStackList freeStack)
{
	XmString oldValue;
	XmString strValue;
...
Var* gui_getXmStringTableFree(const Widget widget, const String resource, const String resourceType)
{
...
Var* gui_getXmStringTable(const Widget widget, const String resource, const String resourceType)
{
	return gui_getXmStringTableCount(widget, resource, 0, -1);
}

Var* gui_getXmStringTableCount(const Widget widget, const String resource, const int free, const int count)
{
	Var* text;
	...
	dbgprintf(
	    "gui_getXmStringTableCount(widget = %ld, "
	...
	if (stringTable == NULL) {
		...
		if (newStrings == NULL) {
			...
			for (stringIdx = 0; stringIdx < stringCount; stringIdx++) {
				...
				if (XmStringGetLtoR(stringTable[stringIdx], XmFONTLIST_DEFAULT_TAG, &strValue)) {
					dbgprintf("strValue = \"%s\"\n", strValue);
					tmpString             = dupString(strValue);
					newStrings[stringIdx] = tmpString;
				} else {
					parse_error(
					    "Warning: unparsable string in XmStringTable "
					    "being ignored.");
				}
			}
...
Var* gui_getEnum(const Widget widget, const String resourceName, const String resourceType)
{
...
XtArgVal gui_setEnum(const Widget widget, const String resourceName, const String resourceType,
                     const Var* value, FreeStackList freeStack)
{
	EnumNameList allowed;
...
Var* gui_getBoolean(const Widget widget, const String resource, const String resourceType)
{
...
XtArgVal gui_setBoolean(const Widget widget, const String resourceName, const String resourceType,
                        const Var* value, FreeStackList freeStack)
{
	Boolean booleanVal = False;

	dbgprintf(
	    "gui_setBoolean(widget = %ld, "
	    "resource = \"%s\", value = %ld)\n",
	    widget, resourceName, value);

	if (widget != NULL) XtVaGetValues(widget, resourceName, &booleanVal, NULL);
...
Var* gui_getBool(const Widget widget, const String resource, const String resourceType)
{
	Bool boolValue;
	char* returnValue;
...
XtArgVal gui_setBool(const Widget widget, const String resourceName, const String resourceType,
                     const Var* value, FreeStackList freeStack)
{
	Bool boolVal = False;

	dbgprintf(
	    "gui_setBool(widget = %ld, "
	    "resource = \"%s\", value = %ld)\n",
	    widget, resourceName, value);

	if (widget != NULL) XtVaGetValues(widget, resourceName, &boolVal, NULL);
...
Var* gui_getByte(Widget widget, String resourceName, String resourceType)
{
	Var* o;
	char byteValue;
...
XtArgVal gui_setByte(const Widget widget, const String resourceName, const String resourceType,
                     const Var* value, FreeStackList freeStack)
{
	unsigned int intVal;
	u_char byteVal;
	...
	if (intVal > MAXBYTE) {
		parse_error(
		    "attempt to set byte resource to value "
...
Var* gui_getShort(const Widget widget, const String resourceName, const String resourceType)
{
	Var* o;
	short shortValue;
...
XtArgVal gui_setShort(const Widget widget, const String resourceName, const String resourceType,
                      const Var* value, FreeStackList freeStack)
{
	int intVal;
	short shortVal;
	...
	if (intVal < SHRT_MIN || intVal > SHRT_MAX) {
		parse_error(
		    "attempt to set short resource to value "
		    "outside allowed range.");
		return (XtArgVal)oldValue;
	}
...
Var* gui_getFloat(const Widget widget, const String resourceName, const String resourceType)
{
	float floatValue;
...
XtArgVal gui_setFloat(const Widget widget, const String resourceName, const String resourceType,
                      const Var* value, FreeStackList freeStack)
{
	float floatValue;
...
Var* gui_getDouble(const Widget widget, const String resourceName, const String resourceType)
{
	double doubleValue;
...
XtArgVal gui_setDouble(const Widget widget, const String resourceName, const String resourceType,
                       const Var* value, FreeStackList freeStack)
{
	double doubleValue;
...
Var* gui_getInt(const Widget widget, const String resourceName, const String resourceType)
{
	Var* o;
	int intValue;

	dbgprintf(
	    "gui_getInt(widget = %ld, "
	    "resourceName = '%s', resourceType = '%s')\n",
...
XtArgVal gui_setInt(const Widget widget, const String resourceName, const String resourceType,
                    const Var* value, FreeStackList freeStack)
{
	int intValue;

	dbgprintf(
	    "gui_setInt(widget = %ld, "
	    "resourceName = '%s', resourceType = '%s', value = %ld)\n",
	    widget, resourceName, resourceType, value);
...
Var* gui_getCardinal(const Widget widget, const String resourceName, const String resourceType)
{
	Var* o;
	Cardinal xtValue;

	dbgprintf(
	    "gui_getCardinal(widget = %ld, "
	    "resourceName = '%s', resourceType = '%s')\n",
	    resourceName, resourceType);
...
XtArgVal gui_setCardinal(const Widget widget, const String resourceName, const String resourceType,
                         const Var* value, FreeStackList freeStack)
{
	Cardinal setValue;

	dbgprintf(
	    "gui_setCardinal(widget = %ld, "
	    "resourceName = '%s', resourceType = '%s', value = %ld)\n",
	    widget, resourceName, resourceType, value);
...
Var* gui_getDimension(const Widget widget, const String resourceName, const String resourceType)
{
	Var* o;
	Dimension dimValue;

	dbgprintf(
	    "gui_getDimension(widget = %ld, "
	    "resourceName = '%s', resourceType = '%s')\n",
	    resourceName, resourceType);
...
XtArgVal gui_setDimension(const Widget widget, const String resourceName, const String resourceType,
                          const Var* value, FreeStackList freeStack)
{
	Dimension setValue;

	dbgprintf(
	    "gui_setDimension(widget = %ld, "
	    "resourceName = '%s', resourceType = '%s', value = %ld)\n",
	    widget, resourceName, resourceType, value);
...
Var* gui_getIgnore(const Widget widget, const String resourceName, const String resourceType)
{
	dbgprintf(
	    "gui_getIgnore(widget = %ld, "
	    "resourceName = '%s', resourceType = '%s')\n",
	    widget, resourceName, resourceType);
...
XtArgVal gui_setReadOnly(const Widget widget, const String resourceName, const String resourceType,
                         const Var* value, FreeStackList freeStack)
{
...
Var* gui_getTextPosition(const Widget widget, const String resourceName, const String resourceType)
{
	Var* o;
	XmTextPosition tpValue;

	dbgprintf(
	    "gui_getTextPosition(widget = %ld, "
	    "resourceName = '%s', resourceType = '%s')\n",
	    widget, resourceName, resourceType);
...
XtArgVal gui_setTextPosition(const Widget widget, const String resourceName,
                             const String resourceType, const Var* value, FreeStackList freeStack)
{
	int intValue;

	dbgprintf(
	    "gui_setTextPosition(widget = %ld, "
	    "resourceName = '%s', resourceType = '%s', value = %ld)\n",
	    widget, resourceName, resourceType, value);
...
void gui_freeStackPush(FreeStackList freeStack, void* address)
{
...
void gui_freeStackFree(FreeStackList freeStack)
{
...
Var* gui_getWidget(const Widget widget, const String resourceName, const String resourceType)
{
	Var* o;
	Widget widgetValue;
	int widgetId;
...
XtArgVal gui_setWidget(const Widget widget, const String resourceName, const String resourceType,
                       const Var* value, FreeStackList freeStack)
{
	int widgetId;
	Widget widgetValue;
...
Narray* gui_extractNarray(const Var* value)
{
	Narray* stringList;
	TextArray textArray;
	int nameIdx, structCount;

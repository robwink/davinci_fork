...
**            -1 if not found
*/
int find_struct(Var* a, const char* b, Var** data)
{
	Var* s;
...
Var* concatenate_struct(Var* a, Var* b)
{
	int i;
	char* name;
	Var* data;
...
Var* remove_struct(Var* s, int pos)
{
